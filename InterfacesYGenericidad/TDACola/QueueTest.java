...
public class QueueTest {
    private Queue<String> c; // interfaz
    ...
    public void enqueueDequeue() {
        ...
        try {
            ...
            assertTrue("luego de insertar 3 elementos y seguidamente eliminar 3 elementos, tamaño != 0",
                    c.size() == 0);
        } catch (EmptyQueueException e) {
        ...
        try {
            c.dequeue();
            fail("al intentar eliminar un elemento de una cola vacía no lanza la excepción EmptyQueueException");
        } catch (EmptyQueueException e) {
        }
    }
}
